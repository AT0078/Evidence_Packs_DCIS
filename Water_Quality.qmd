...
WWTW <- readxl:: read_excel("/dbfs/FileStore/WSX_HGray/ETL_Exports/STW_spreadsheet_DRAFT.xlsx", sheet= "MASTER", skip=1)
...
sewage <- readxl::read_excel("/dbfs/FileStore/WSX_HGray/ETL_Exports/EDM_2024_Storm_Overflow_Annual_Return___all_water_and_sewerage_companies.xlsx", sheet="Wessex Water 2024", skip=1)
...
# Crop sf
 ...
 # Convert 1899-12-30 to POSIXct
  ...
  durations_in_hrs <- as.numeric(sewage$`Total Duration (hh:mm:ss) all spills prior to processing through 12-24h count method` - origin, units = "hours")
  sewage$Total_spill_hrs_2024 <- durations_in_hrs
...
sequ <- seq(min(sewage$Total_spill_hrs_2024), max(sewage$Total_spill_hrs_2024), length.out = 5)
...
gdb <- st_read("/dbfs/FileStore/WSX_HGray/ETL_Exports/WessexRiskAttributedOLF.gdb", quiet = TRUE)
...
Phys_Chem_Site <- readxl::read_excel("/dbfs/FileStore/WSX_HGray/ETL_Exports/2022_Phys_Chem_Classification_QA_document__RAW_.xlsx", sheet= "Site Class")
