...
# Load your data
CDE <- read.csv("/dbfs/mnt/lab/unrestricted/harry.gray@environment-agency.gov.ukCEP/WFD_Wessex_2024.csv")
...
inv <- read.csv("/dbfs/mnt/lab/unrestricted/harry.gray@environment-agency.gov.ukCEP/Inv_WSX.csv") %>% 
                rename_with(tolower)
...
Rivers_250k <- read_sf("/dbfs/mnt/lab/unrestricted/harry.gray@environment-agency.gov.ukCEP/Hydrology/Rivers_250k.shp")
